...
CONSTRAINT uni_an_cf UNIQUE (cf)
);
...
CONSTRAINT uni_cli_anag UNIQUE (id_anag),
CONSTRAINT FK_ANAG
    FOREIGN KEY (ID_ANAG)
...
CONSTRAINT uni_am_cod UNIQUE (cod),
...
CONSTRAINT uni_st_anag UNIQUE (id_anag)
);
...
"NOME" VARCHAR2(30 BYTE),
"COD" VARCHAR2(32 BYTE),
CONSTRAINT uni_te_cod UNIQUE (cod),
...
CONSTRAINT uni_me_anag UNIQUE (id_anag),
